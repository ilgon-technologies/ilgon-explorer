defmodule BlockScoutWeb.ChainView do
  ...
  defp market_cap(:standard, %{usd_value: usd_value})
       when is_nil(usd_value) do
    Decimal.new(0)
  end

  defp market_cap(:standard, %{usd_value: usd_value}) do
    Decimal.mult(%Wei{value: AddressSum.get_sum()} |> Wei.to(:ether), usd_value)
  end
